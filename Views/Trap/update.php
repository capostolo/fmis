  ...
  $attributes = array('class' => 'form', 'id' => 'update-item');
	...
	<div class='row'>
		<div class='form-group col-4' > 
          ...
          <input type='text' class='form-control ' name='trap_description' id='trap_description' value='<?= set_value('trap_description', $row->trap_description) ?>' required />
        </div> 
<div class='form-group col-4' > 

          <label class='control-label' for='active_substance'><?= lang('Fmis.active_substance') ?></label>
          <input type='text' class='form-control ' name='active_substance' id='active_substance' value='<?= set_value('active_substance', $row->active_substance) ?>' required />
        </div> 
<div class='form-group col-4' > 
	...
	<div class='row'>
		<div class='form-group col'>
			<a class='btn btn-default form-control' href="<?= site_url('fmis/trap') ?>"><?= lang('Fmis.go_back');?></a>
		</div>
		<div class='form-group col'>
