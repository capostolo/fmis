  ...
  $attributes = array('class' => 'form', 'id' => 'update-item');
	...
	<div class='row'>
		<div class='form-group col-6' > 
          ...
          <input type='text' class='form-control ' name='specialised_fertiliser_description' id='specialised_fertiliser_description' value='<?= set_value('specialised_fertiliser_description', $row->specialised_fertiliser_description) ?>' required />
        </div> 
	...
	<div class='row'>
		<div class='form-group col'>
			<a class='btn btn-default form-control' href="<?= site_url('fmis/specialised-fertiliser') ?>"><?= lang('Fmis.go_back');?></a>
		</div>
		<div class='form-group col'>
