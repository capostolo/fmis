...
<?php
	$attributes = array('class' => 'form', 'id' => 'add-farm_inputs');
...
<div class='form-group col-12' > 
          ...
          <select class='form-control selectpicker' name='input_id' id='input_id' data-live-search='true' data-style='' data-style-base='form-control' data-virtual-scroll='200' required>
...
<div class='form-group col-4' > 
          ...
          <input type='text' class='form-control ' name='packages' id='packages' required />
        </div> 
<div class='form-group col-4' > 

          <label class='control-label' for='unit_quantity'><?= lang('Fmis.unit_quantity') ?></label>
          <input type='text' class='form-control ' name='unit_quantity' id='unit_quantity' required />
        </div> 
<div class='form-group col-4' > 
	...
	<div class='row'>
		<div class='form-group col'>
			<a class='btn btn-default form-control' href="<?php echo site_url('fmis/farm-inputs') ?>"><?= lang('Fmis.go_back');?></a>
		</div>
		<div class='form-group col'>
