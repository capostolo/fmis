  ...
  $attributes = array('class' => 'form', 'id' => 'update-item');
	...
	<div class='row'>
		<div class='form-group col-6' > 
          ...
          <input type='text' class='form-control ' name='supplier_name' id='supplier_name' value='<?= set_value('supplier_name', $row->supplier_name) ?>' required />
        </div> 
<div class='form-group col-6' > 

          <label class='control-label' for='supplier_afm'><?= lang('Fmis.supplier_afm') ?></label>
          <input type='text' class='form-control ' name='supplier_afm' id='supplier_afm' value='<?= set_value('supplier_afm', $row->supplier_afm) ?>' required />
        </div> 
	...
	<div class='row'>
		<div class='form-group col'>
			<a class='btn btn-default form-control' href="<?= site_url('fmis/supplier') ?>"><?= lang('Fmis.go_back');?></a>
		</div>
		<div class='form-group col'>
