  ...
  $attributes = array('class' => 'form', 'id' => 'update-item');
	...
	<div class='row'>
		<div class='form-group col-6' > 
          ...
          <input type='text' class='form-control ' name='buyer_name' id='buyer_name' value='<?= set_value('buyer_name', $row->buyer_name) ?>' required />
        </div> 
<div class='form-group col-6' > 

          <label class='control-label' for='buyer_afm'><?= lang('Fmis.buyer_afm') ?></label>
          <input type='text' class='form-control ' name='buyer_afm' id='buyer_afm' value='<?= set_value('buyer_afm', $row->buyer_afm) ?>' required />
        </div> 
	...
	<div class='row'>
		<div class='form-group col'>
			<a class='btn btn-default form-control' href="<?= site_url('fmis/buyer') ?>"><?= lang('Fmis.go_back');?></a>
		</div>
		<div class='form-group col'>
