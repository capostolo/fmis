	...
	<div class='row mt-3'>
		<div class='col-12'>
			<table class='table table-hover table-striped dtable'>
				<thead>
					<tr>
            			<th><?= lang('Fmis.pruning_equipment');?></th>
				...
				<tbody>
					<?php foreach ($rows As $r) { ?>
						<tr>
							<td><a href="<?= site_url('fmis/pruning-equipment/'.$r->id) ?>" > <?= $r->pruning_equipment_description ?> </a></td>
							<td class="text-right">
								<button class="btn btn-default btn-sm delItem" data-controller="pruning-equipment" data-item-id="<?= $r->id ?>">
