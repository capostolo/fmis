...
<div class='form-group col-6' > 
          ...
          <select class='form-control' name='harvest_equipment_id' id='harvest_equipment_id' required>
            ...
            $harvest_equipment_value = $row->harvest_equipment_id ?? $directive->harvest_equipment_id;
            ?>
            <option value='<?= $r->id ?>' <?= set_select('harvest_equipment_id', $r->id, $r->id == $harvest_equipment_value) ?>> <?= $r->harvest_equipment_description ?> </option>
            <?php } ?>
          </select>
        </div> 
