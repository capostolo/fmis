...
<?php
  $attributes = array('class' => 'form', 'id' => 'update-item');
	echo form_open(site_url('fmis/irrigation'), $attributes);
	?>
	<div class='row'>
...
<div class='form-group col-4' > 
          ...
          <input type='text' class='form-control ' name='suppling_hours' id='suppling_hours' value='<?= set_value('suppling_hours', $row->suppling_hours) ?>' required />
        </div> 
<div class='form-group col-4' > 
