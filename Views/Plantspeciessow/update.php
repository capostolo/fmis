  ...
  $attributes = array('class' => 'form', 'id' => 'update-item');
	...
	<div class='row'>
		<div class='form-group col-6' > 
          ...
          <input type='text' class='form-control ' name='plant_species_sow_description' id='plant_species_sow_description' value='<?= set_value('plant_species_sow_description', $row->plant_species_sow_description) ?>' required />
        </div> 
	...
	<div class='row'>
		<div class='form-group col'>
			<a class='btn btn-default form-control' href="<?= site_url('fmis/plant-species-sow') ?>"><?= lang('Fmis.go_back');?></a>
		</div>
		<div class='form-group col'>
