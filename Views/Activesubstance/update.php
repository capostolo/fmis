  ...
  $attributes = array('class' => 'form', 'id' => 'update-item');
	...
	<div class='row'>
		<div class='form-group col-6' > 
          ...
          <input type='text' class='form-control ' name='description' id='description' value='<?= set_value('description', $row->description) ?>' required />
        </div> 
	...
	<div class='row'>
		<div class='form-group col'>
			<a class='btn btn-default form-control' href="<?= site_url('fmis/active-substance') ?>"><?= lang('Fmis.go_back');?></a>
		</div>
		<div class='form-group col'>
