...
<?php
	$attributes = array('class' => 'form', 'id' => 'add-pruning-global');
	echo form_open(site_url('fmis/pruning-global-new'), $attributes);
	?>
	<div class='row'>
		...
		<div class='form-group col-4'> 
			...
			<select class='form-control selectpicker' name='pruning_type_id' id='pruning_type_id' data-live-search='true' required>
		...
		<div class='form-group col-4'> 
			...
			<select class='form-control selectpicker' name='pruning_equipment_id' id='pruning_equipment_id' data-live-search='true' required>
...
$('#add-pruning-global').submit(function(event) {
