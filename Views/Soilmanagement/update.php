...
<?php
  $attributes = array('class' => 'form', 'id' => 'update-item');
	echo form_open(site_url('fmis/soil-management'), $attributes);
	?>
	<div class='row'>
...
<div class='form-group col-12'> 
          ...
          <textarea class='form-control' name='purpose_description' id='purpose_description' required > <?= set_value('purpose_description', $row->purpose_description) ?></textarea>
        </div> 
...
<div class='form-group col-3' > 
          ...
          <input type='text' class='form-control ' name='seed_needed' id='seed_needed' value='<?= set_value('seed_needed', $row->seed_needed) ?>'  />
        </div> 
<div class='form-group col-3' > 
...
<div class='form-group col-3' > 
          ...
          <input type='text' class='form-control ' name='cover_crop_seed' id='cover_crop_seed' value='<?= set_value('cover_crop_seed', $row->cover_crop_seed) ?>'  />
        </div> 
