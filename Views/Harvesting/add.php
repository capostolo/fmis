...
<?php
	$attributes = array('class' => 'form', 'id' => 'add-harvesting');
...
<div class='form-group col-4'> 
	...
	<div class='row'>
		...
		<div class='form-group col'>
			<button class='btn btn-custom-green form-control' name='new_harvesting' id='new_harvesting'><?= lang('Fmis.save');?></button>
		</div>
	</div>
	<?php echo form_close() ?>
</div>
