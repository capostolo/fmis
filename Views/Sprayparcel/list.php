...
<div class='container'>
  <div class="text-custom-anthrax text-center">
    ...
    <div class='col-3'>
      <a class='btn btn-custom-green form-control' href='<?= site_url('fmis/spray-parcel/new') ?>'><?= lang('Fmis.new_item');?></a>
    </div>
 </div>
	<div class='row mt-3'>
		<div class='col-12'>
            ...
            <th><?= lang('Fmis.application_date');?></th>
				...
				<tbody>
					<?php foreach ($rows As $r) { ?>
						<tr>
							<td><a href="<?= site_url('fmis/spray-parcel/'.$r->spray_parcel_id) ?>" > <?= lang('Fmis.sparcel') ?> </a></td>
      ...
      <div class='col-12'>
        <p class='text-center'>
          <a class='btn btn-custom-green' href='<?= site_url('fmis/spray-parcel/new') ?>'><?= lang('Fmis.new_item');?></a>
        </p>
      </div>
			<?php } ?>
		</div>
